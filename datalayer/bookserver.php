...
if(count($errors)==0){
	...
	$sql = "INSERT INTO  bookapp (AppoID, Date, Time, patientID,docID) VALUES ('$AppoID','$Date','$Time','101','$docID') ";
...
if (isset($_POST['cancel'])) {
 ...
 if (count($errors)==0) {
	...
	$query5="DELETE FROM bookapp WHERE AppoID='567' AND patientID=('101') ";
